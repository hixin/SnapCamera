...
//        task.execute();
    ...
    public static final class PhotoData extends LocalMediaData {
        ...
        static final Uri CONTENT_URI = Images.Media.EXTERNAL_CONTENT_URI;

        static final String QUERY_ORDER = Images.ImageColumns.DATE_TAKEN + " DESC, "
                + Images.ImageColumns._ID + " DESC";
        /**
         * These values should be kept in sync with column IDs (COL_*) above.
         */
        static final String[] QUERY_PROJECTION = {
                Images.ImageColumns._ID,           // 0, int
                Images.ImageColumns.TITLE,         // 1, string
                Images.ImageColumns.MIME_TYPE,     // 2, string
                Images.ImageColumns.DATE_TAKEN,    // 3, int
                Images.ImageColumns.DATE_MODIFIED, // 4, int
                Images.ImageColumns.DATA,          // 5, string
                Images.ImageColumns.ORIENTATION,   // 6, int, 0, 90, 180, 270
                Images.ImageColumns.WIDTH,         // 7, int
                Images.ImageColumns.HEIGHT,        // 8, int
                Images.ImageColumns.SIZE,          // 9, long
                Images.ImageColumns.LATITUDE,      // 10, double
                Images.ImageColumns.LONGITUDE      // 11, double
        };
        ...
        public boolean delete(Context c) {
            ...
            cr.delete(CONTENT_URI, Images.ImageColumns._ID + "=" + mContentId, null);
